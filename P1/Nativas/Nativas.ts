...
function desapilar() : void{
  if(stack.length == MINZIE){
    ...
    //TODO: AL POPO LO IGUALE A UNA VARIABLE
    let a = stack.pop();
  }
}
...
console.log(stack);
let temp:string = "";
//TODO: NO TENGO FOR OF, LO REEMPLACE POR EL FOR NORMAL
for(let cont=0; cont< stack.length;cont++){
  temp = temp + "|" + cont + "|" + stack[cont] + "|\n";
}
console.log("Pos | Val \n"+temp);
