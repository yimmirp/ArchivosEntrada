...
let parametro ="oy ganO compi2";
let hola="hola";
let lower = hola.toLowerCase();
let chart = lower.chartAt(0);
let concatenacion = chart.concat(parametro);
let uper = concatenacion.toUpperCase();
